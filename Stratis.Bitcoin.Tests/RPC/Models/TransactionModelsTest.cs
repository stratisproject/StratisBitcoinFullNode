...
namespace Stratis.Bitcoin.Tests.RPC.Models
{
    ...
    {
        public class TransactionModelsTestCreateTransactions
        {
            public static TransactionModelsTestCreateTransactions Create()
            {
                return new TransactionModelsTestCreateTransactions();
            }

            public TransactionModelsTestCreateTransactions()
            {
            ...
            public const string txBlock10Hex = "";
            public const string txBlock10Hash = "d3ad39fa52a89997ac7381c95eeffeaf40b66af7a57e9eba144be0a175a12b11";
            public TransactionBriefModel txBlock10CoinbaseModelBrief;

            public const string txBlock460373CoinbaseHex = "";
            public const string txBlock460373CoinbaseHash = "ed6cadd7028e1406b766a57b14998f47ce5c44ec594ce7c26a6c5eab98f2e8dd";
            public TransactionVerboseModel txBlock460373CoinbaseModelVerbose;

            public const string txTwoInTwoOutHex = "";
            public const string txTwoInTwoOutHash = "951f379563ab5631dd2d249f06e76fe0ad19c03caabb22db2352f47ddc51fc31";
            public TransactionVerboseModel txTwoInTwoOutModelVerbose;
        }

        [Fact]
        public void TransactionModelBriefRenderTest()
        {
            var model = TransactionModelsTestCreateTransactions.Create().txBlock10CoinbaseModelBrief;
            string json = ModelToJson(model);

            string expectedJson = "\"" + TransactionModelsTestCreateTransactions.txBlock10Hex + "\"";
        ...
        public void TransactionModelVerboseRenderTest()
        {
            ...
            JObject obj = ModelToJObject(TransactionModelsTestCreateTransactions.Create().txBlock460373CoinbaseModelVerbose);
            ...
            Assert.Equal(TransactionModelsTestCreateTransactions.txBlock460373CoinbaseHex, actualHex);
            Assert.Equal(TransactionModelsTestCreateTransactions.txBlock460373CoinbaseHash, actualTxid);
        ...
        public void TransactionModelVerboseRenderNonCoinbaseTest()
        {
            ...
            JObject obj = ModelToJObject(TransactionModelsTestCreateTransactions.Create().txTwoInTwoOutModelVerbose);
            Assert.True(obj.HasValues);
            var vin = obj["vin"];
