...
namespace NBitcoin.Tests
{
    public class Script_Tests
    {
        ...
        {
            Transaction tx = this.consensusFactory.CreateTransaction("");
            ...
            PayToMultiSigTemplateParameters result = PayToMultiSigTemplate.Instance.ExtractScriptPubKeyParameters(this.network, redeemScript);
        ...
        {
            Transaction spendingTransaction = this.consensusFactory.CreateTransaction();
        ...
        private Transaction CreateCreditingTransaction(Script scriptPubKey, Money amount = null)
        {
            ...
            Transaction creditingTransaction = this.consensusFactory.CreateTransaction();
        ...
        public void Script_CHECKMULTISIG12()
        {
            ...
            Transaction txFrom12 = this.consensusFactory.CreateTransaction();
            txFrom12.Outputs.Add(new TxOut());
            txFrom12.Outputs[0].ScriptPubKey = scriptPubKey12;


            Transaction txTo12 = this.consensusFactory.CreateTransaction();
        ...
        public void Script_CHECKMULTISIG23()
        {
            ...
            Transaction txFrom23 = this.consensusFactory.CreateTransaction();
            txFrom23.Outputs.Add(new TxOut());
            txFrom23.Outputs[0].ScriptPubKey = scriptPubKey23;

            Transaction txTo23 = this.consensusFactory.CreateTransaction();
        ...
        {
            Transaction tx = this.consensusFactory.CreateTransaction("");
        ...
        public void CanParseAndGeneratePayToMultiSig()
        {
            ...
            PayToMultiSigTemplateParameters scriptPubKeyResult = PayToMultiSigTemplate.Instance.ExtractScriptPubKeyParameters(this.network, new Script(scriptPubKey));
