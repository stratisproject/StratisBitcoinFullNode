    ...
    public class ColoredCoinsTests
    {
        private class ColoredCoinTester
        {
            public ColoredCoinTester(Network network, [CallerMemberName]string test = null)
            {
                ...
                {
                    Transaction txObj = network.Consensus.ConsensusFactory.CreateTransaction(tx);
        ...
        public void CanColorizeSpecScenario()
        {
            ...
            Transaction prior = this.network.Consensus.ConsensusFactory.CreateTransaction();
            ...
            Transaction issuanceA1 = this.network.Consensus.ConsensusFactory.CreateTransaction();
            ...
            Transaction issuanceA2 = this.network.Consensus.ConsensusFactory.CreateTransaction();
        ...
        {
            Transaction testedTx = this.network.Consensus.ConsensusFactory.CreateTransaction();
        ...
        {
            Transaction tx = this.network.Consensus.ConsensusFactory.CreateTransaction("");
