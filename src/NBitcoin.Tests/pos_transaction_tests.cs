    ...
    public class Pos_Transaction_Tests
    {
        ...
        public void CanBuildIssueColoredCoinWithMultiSigP2SH()
        {
            ...
            Assert.True(
                new TransactionBuilder(this.network)
                {
                    StandardTransactionPolicy = EasyPolicy(this.network)
                }
                .AddCoins(issuanceCoin)
                .Verify(aliceSigned));
            ...
            builder.StandardTransactionPolicy = RelayPolicy(this.network).Clone();
        ...
        private void CanBuildColoredTransaction()
        {
            ...
            Transaction funding =
                new TransactionBuilder(this.network)
                {
                    StandardTransactionPolicy = RelayPolicy(this.network)
                }
                .AddCoins(issuanceCoins)
                .AddKeys(gold)
        ...
        public void CanBuildStealthTransaction()
        {
            ...
            var darkSatoshi = new BitcoinStealthAddress(scanKey.PubKey, stealthKeys.Select(k => k.PubKey).ToArray(), 2, new BitField(3, 5), Networks.Main);
            ...
            var builder = new TransactionBuilder(this.network);
            builder.StandardTransactionPolicy = EasyPolicy(this.network);
            Transaction tx =
                builder
                .AddCoins(coins)
                .AddKeys(bob)
        ...
        {
            return RandomCoin(amount, receiver.PubKey.GetAddress(Networks.Main));
        }
        ...
        public void CanEstimatedFeesCorrectlyIfFeesChangeTransactionSize()
        {
            ...
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 1), new TxOut("0.00010000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Networks.Main))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 2), new TxOut("0.00091824", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Networks.Main))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 3), new TxOut("0.00100000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Networks.Main))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 4), new TxOut("0.00100000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Networks.Main))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 5), new TxOut("0.00246414", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Networks.Main))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 6), new TxOut("0.00250980", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Networks.Main))).ToScriptCoin(redeem));
            transactionBuilder.AddCoins(new Coin(new OutPoint(uint256.Parse("75425c904289f21feef0cffab2081ba22030b633623115adf0780edad443e6c7"), 7), new TxOut("0.01000000", PayToScriptHashTemplate.Instance.GenerateScriptPubKey(redeem).GetDestinationAddress(Networks.Main))).ToScriptCoin(redeem));
            transactionBuilder.Send(new Key().PubKey.GetAddress(Networks.Main), "0.01000000");
            transactionBuilder.SetChange(new Key().PubKey.GetAddress(Networks.Main));
        ...
        public void CanBuildTransactionWithDustPrevention()
        {
            ...
            var builder = new TransactionBuilder(this.network);
            builder.StandardTransactionPolicy = EasyPolicy(this.network).Clone();
        ...
        public void CanPartiallySignTransaction()
        {
            ...
            // Taken from example
            Transaction fundingTransaction = this.network.CreateTransaction("");
            ...
            Transaction gistTransaction = this.network.CreateTransaction("");
        ...
        {
            Transaction funding = this.network.CreateTransaction("");
            Transaction spending = this.network.CreateTransaction("");
        ...
        private void CanCheckSegwitSig()
        {
            ...
            CanCheckSegwitSigCore(this.network, tx, 0, Money.Coins(1.0m));
            ...
            ScriptError error;
            Assert.True(toCheck.Inputs.AsIndexedInputs().Skip(0).First().VerifyScript(this.network, new Script("OP_HASH160 442afa4f034468652c571202da0bf277cb729def OP_EQUAL"), Money.Satoshis(100000), ScriptVerify.Mandatory, out error));
        }
        ...
        public void CanParseWitTransaction()
        {
            ...
            tx = this.network.CreateTransaction("");

            ScriptError error;
            Assert.False(tx.Inputs.AsIndexedInputs().First().VerifyScript(this.network, new Script("0 b7854eb547106248b136ca2bf48d8df2f1167588"), out error));
        ...
        private void Bip143Test()
        {
            ...
            uint256 h = Script.SignatureHash(this.network, new Script(Encoders.Hex.DecodeData("76a9141d0f172a0ecb48aee1be1f2687d2963ae33f71a188ac")), tx, 1, SigHash.All, Money.Satoshis(0x23c34600L), HashVersion.Witness);
        ...
        private void PlayingWithSignatures()
        {
            ...
            ECDSASignature sig1 = (PayToPubkeyHashTemplate.Instance.ExtractScriptSigParameters(this.network, script1).TransactionSignature.Signature);
            ECDSASignature sig2 = (PayToPubkeyHashTemplate.Instance.ExtractScriptSigParameters(this.network, script2).TransactionSignature.Signature);
        ...
        public void CheckScriptCoinIsCoherent()
        {
            ...
            Assert.Throws<ArgumentException>(() => ScriptCoin.Create(this.network, c, key.PubKey.ScriptPubKey.WitHash.ScriptPubKey));
        }
        ...
        public void CheckWitnessSize()
        {
            ...
            ScriptError error;
            Assert.True(tx.Inputs.AsIndexedInputs().First().VerifyScript(this.network, coin1, ScriptVerify.Standard, out error));
            ...
            tx.Inputs[0].ScriptSig = Script.Empty;
            tx.Outputs.Add(new TxOut(Money.Zero, new Script(OpcodeType.OP_TRUE)));
            Assert.False(tx.Inputs.AsIndexedInputs().First().VerifyScript(this.network, coin1, ScriptVerify.Standard, out error));
        ...
        {
            var secret = new BitcoinSecret("L5AQtV2HDm4xGsseLokK2VAT2EtYKcTm3c7HwqnJBFt9LdaQULsM", Networks.Main);
                ...
                foreach (SigHash flag in new[] { SigHash.Single, SigHash.None, SigHash.All })
                {
                    foreach (bool anyoneCanPay in new[] { true, false })
                    {
                        ...
                        foreach (HashModification modification in new[] { HashModification.NoModification, HashModification.Modification, HashModification.Invalid })
                        {
                            ...
                            TransactionSignature sig = PayToPubkeyHashTemplate.Instance.ExtractScriptSigParameters(this.network, signedInput.WitScript == WitScript.Empty ? signedInput.ScriptSig : signedInput.WitScript.ToScript()).TransactionSignature;
                            if (modification != HashModification.Invalid)
                            {
                                signatures.Add(sig);
        ...
        {
            Transaction[] dummyTransactions = Enumerable.Range(0, 2).Select(_ => this.network.CreateTransaction()).ToArray();
            ...
            dummyTransactions[1].Outputs[0].ScriptPubKey = key[2].PubKey.GetAddress(Networks.Main).ScriptPubKey;
            dummyTransactions[1].Outputs[1].Value = 22 * Money.CENT;
            dummyTransactions[1].Outputs[1].ScriptPubKey = key[3].PubKey.GetAddress(Networks.Main).ScriptPubKey;
