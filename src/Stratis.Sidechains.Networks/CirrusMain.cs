...
namespace Stratis.Sidechains.Networks
{
    ...
    public class CirrusMain : PoANetwork
    {
        ...
        internal CirrusMain()
        {
            ...
            this.GenesisTime = 1570630821;
            this.GenesisNonce = 4813038;
            ...
            {
                new CollateralFederationMember(new Mnemonic("basic exotic crack drink left judge tourist giggle muscle unique horn body").DeriveExtKey().PrivateKey.PubKey, false, new Money(0), "SgKKjTJBAEk1WXMYTeR5XHCF1cVsAFR8D8")
            };
            ...
            Assert(this.Consensus.HashGenesisBlock == uint256.Parse("6b940afbd10d118f7a551178a707c08da679f433eda2ec3abc4c836a92333e18"));
