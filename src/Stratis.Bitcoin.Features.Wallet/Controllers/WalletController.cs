...
namespace Stratis.Bitcoin.Features.Wallet.Controllers
{
    ...
    public class WalletController : Controller
    {
        ...
        /// </summary>
        /// <param name="request">The parameters required for generating the cold-staking-address.</param>
        ...
        public IActionResult GetColdStakingAddress([FromBody]GetColdStakingAddressRequest request)
        {
            ...
            try
            {
                ...
                {
                    Address = wallet.GetColdStakingAddress(request.WalletPassword, request.IsColdWalletAddress).Address
                };
        ...
        /// Setup cold staking.
        /// </summary>
        /// <param name="request">The cold staking setup parameters.</param>
        /// <returns>The change of the cold staking setup transaction.</returns>
        ...
        public IActionResult SetupColdStaking([FromBody]SetupColdStakingRequest request)
        {
            ...
            try
            {
                ...
                TransactionBuildContext context = this.walletManager.GetSetupBuildContext(request.ColdWalletAddress,
