    ...
    public sealed class PeerConnectorDiscovery : PeerConnector
    {
        ...
        public override PeerAddress FindPeerToConnectTo()
        {
            ...
            while (!this.nodeLifetime.ApplicationStopping.IsCancellationRequested)
            {
                ...
                var peerExistsInAddNode = this.NodeSettings.ConnectionManager.AddNode.Contains(peer.NetworkAddress.Endpoint);
                ...
                // try and connect to it.
                var peerExistsInConnectNode = this.NodeSettings.ConnectionManager.Connect.Contains(peer.NetworkAddress.Endpoint);
