...
namespace Stratis.Bitcoin.P2P.Peer
{
    public class NetworkPeerServer : IDisposable
    {
        ...
        private bool AllowClientConnection(TcpClient tcpClient)
        {
            ...
            bool endpointCanBeWhiteListed = clientLocalEndPoint.CanBeMappedTo(this.connectionManagerSettings.ListenOn.Select(x => x.Endpoint).ToList(), out IPEndPoint endpoint);
