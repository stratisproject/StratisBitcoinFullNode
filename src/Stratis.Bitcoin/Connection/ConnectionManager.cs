    ...
    public sealed class ConnectionManager : IConnectionManager
    {
        ...
        public void Start()
        {
            ...
            else
            {
                ...
                this.ConnectNodePeerConnector = this.CreatePeerConnector(clonedParameters, NodeServices.Nothing, PeerIntroductionType.Connect, this.connectionManagerSettings.Connect.Count);
            }

            {
                ...
                this.AddNodePeerConnector = this.CreatePeerConnector(clonedParameters, NodeServices.Nothing, PeerIntroductionType.Add, this.connectionManagerSettings.AddNode.Count);
            }
            ...
            int? maximumNodeConnections = 8)
        {
            ...
            var peerConnector = new PeerConnector(this.Network, this.nodeLifetime, parameters, nodeRequirement, this.asyncLoopFactory, this.peerAddressManager, peerIntroductionType)
            {
