...
namespace Stratis.Bitcoin.Connection
{
    public sealed class ConnectionManager : IConnectionManager
    {
        ...
        public void Initialize(IConsensusManager consensusManager)
        {
            ...
            if (!this.ConnectionSettings.Connect.Any() || this.ConnectionSettings.Listen)
            ...
            else
            {
                ...
                IPEndPoint nodeServerEndpoint = this.ConnectionSettings.ListenOn?.FirstOrDefault(x => x.Endpoint.Address.IsRoutable(false))?.Endpoint;
        ...
        private void StartNodeServer()
        {
            ...
            foreach (NodeServerEndpoint listen in this.ConnectionSettings.ListenOn)
            {
