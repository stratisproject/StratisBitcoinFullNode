namespace Stratis.Bitcoin.Consensus
{
    ...
    public static class ConsensusErrors
    {
        ...
        public static ConsensusError InvalidPreviousProvenHeaderStakeModifier => new ConsensusError("proven-header-invalid-previous-header-stake-modifier", "previous proven header's StackModifier is null");
