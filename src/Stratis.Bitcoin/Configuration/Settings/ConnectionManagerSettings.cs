...
namespace Stratis.Bitcoin.Configuration.Settings
{
    ...
    public sealed class ConnectionManagerSettings
    {
        ...
        public ConnectionManagerSettings(NodeSettings nodeSettings)
        {
            ...
            this.BanTimeSeconds = config.GetOrDefault<int>("bantime", nodeSettings.Network.BanTimeSeconds, this.logger);
        ...
        public static void BuildDefaultConfigurationFile(StringBuilder builder, Network network)
        {
            ...
            builder.AppendLine($"#Number of seconds to keep misbehaving peers from reconnecting. Default {network.BanTimeSeconds}.");
        ...
        public static void PrintHelp(Network network)
        {
            ...
            builder.AppendLine($"-bantime=<number>         Number of seconds to keep misbehaving peers from reconnecting. Default {network.BanTimeSeconds}.");
