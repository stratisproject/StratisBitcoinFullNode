...
namespace Stratis.SmartContracts.CLR.Tests
{
    public class StateTransitionSpecification
    {
        ...
        public void ExternalCreate_Success()
        {
            ...
            this.vm.Setup(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), It.IsAny<RuntimeObserver.IGasMeter>(), externalCreateMessage.Code, externalCreateMessage.Parameters, null))
            ...
            this.vm.Verify(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), It.IsAny<RuntimeObserver.IGasMeter>(), externalCreateMessage.Code, externalCreateMessage.Parameters, null), Times.Once);
        ...
        public void ExternalCall_Success()
        {
            ...
            this.vm.Setup(v =>
                    v.ExecuteMethod(It.IsAny<ISmartContractState>(), It.IsAny<RuntimeObserver.IGasMeter>(), It.IsAny<ExecutionContext>(), externalCallMessage.Method, code, typeName))
                .Returns(vmExecutionResult);
            ...
            this.vm.Verify(
                v => v.ExecuteMethod(It.IsAny<ISmartContractState>(), It.IsAny<RuntimeObserver.IGasMeter>(), It.IsAny<ExecutionContext>(), externalCallMessage.Method, code, typeName),
                Times.Once);
        ...
        public void InternalCreate_Success()
        {
            ...
            this.vm.Setup(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), It.IsAny<RuntimeObserver.IGasMeter>(), code, internalCreateMessage.Parameters, internalCreateMessage.Type))
                .Returns(vmExecutionResult);
            ...
            this.vm.Verify(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), It.IsAny<RuntimeObserver.IGasMeter>(), code, internalCreateMessage.Parameters, internalCreateMessage.Type), Times.Once);
        ...
        public void InternalCreate_Vm_Error()
        {
            ...
            this.vm.Setup(v =>
                    v.Create(It.IsAny<IStateRepository>(),
                        It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(),
        ...
        public void Create_Out_Of_Gas_Error()
        {
            ...
            this.vm.Setup(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), It.IsAny<RuntimeObserver.IGasMeter>(), createMessage.Code, createMessage.Parameters, null))
                .Returns(vmExecutionResult);
            ...
            this.vm.Verify(v => v.Create(this.contractStateRoot.Object, It.IsAny<ISmartContractState>(), It.IsAny<ExecutionContext>(), It.IsAny<RuntimeObserver.IGasMeter>(), createMessage.Code, createMessage.Parameters, null), Times.Once);
        ...
        public void InternalCall_Success()
        {
            ...
            this.vm.Setup(v => v.ExecuteMethod(It.IsAny<ISmartContractState>(), It.IsAny<RuntimeObserver.IGasMeter>(), It.IsAny<ExecutionContext>(), internalCallMessage.Method, code, typeName))
                .Returns(vmExecutionResult);
            ...
            // Verify the VM was invoked
            this.vm.Verify(v => v.ExecuteMethod(It.IsAny<ISmartContractState>(), It.IsAny<RuntimeObserver.IGasMeter>(), It.IsAny<ExecutionContext>(), internalCallMessage.Method, code, typeName), Times.Once);
        ...
        public void InternalCall_Vm_Error()
        {
            ...
            this.vm.Setup(v => v.ExecuteMethod(
                    ...
                    It.IsAny<RuntimeObserver.IGasMeter>(), It.IsAny<ExecutionContext>(),
        ...
        public void Contract_Transfer_To_Other_Contract_Success()
        {
            ...
            this.vm.Setup(v => v.ExecuteMethod(It.IsAny<ISmartContractState>(), It.IsAny<RuntimeObserver.IGasMeter>(), It.IsAny<ExecutionContext>(),contractTransferMessage.Method, code, typeName))
                .Returns(vmExecutionResult);
            ...
            // Verify the VM was invoked
            this.vm.Verify(v => v.ExecuteMethod(It.IsAny<ISmartContractState>(), It.IsAny<RuntimeObserver.IGasMeter>(), It.IsAny<ExecutionContext>(), contractTransferMessage.Method, code, typeName), Times.Once);
        ...
        public void Contract_Transfer_To_Other_P2PKH_Success()
        {
            ...
            this.vm.Verify(v => v.ExecuteMethod(It.IsAny<ISmartContractState>(), It.IsAny<RuntimeObserver.IGasMeter>(), It.IsAny<ExecutionContext>(), It.IsAny<MethodCall>(), It.IsAny<byte[]>(), It.IsAny<string>()), Times.Never);
