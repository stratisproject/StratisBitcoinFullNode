...
namespace Stratis.Features.FederatedPeg.Tests
{
    public class CollateralCheckerTests
    {
        ...
        public async Task CanInitializeAndCheckCollateralAsync()
        {
            ...
            var collateralData = new AddressIndexerBalancesResult()
            {
                Balances = new List<AddressIndexerBalanceResult>()
                {
                    new AddressIndexerBalanceResult( this.collateralFederationMembers[0].CollateralMainchainAddress, this.collateralFederationMembers[0].CollateralAmount) ,
                    new AddressIndexerBalanceResult(this.collateralFederationMembers[1].CollateralMainchainAddress, this.collateralFederationMembers[1].CollateralAmount + 10),
                    new AddressIndexerBalanceResult(this.collateralFederationMembers[2].CollateralMainchainAddress, this.collateralFederationMembers[2].CollateralAmount - 10)
                }
            };
            ...
            AddressIndexerBalanceResult updated = collateralData.Balances.First(b => b.Address == this.collateralFederationMembers[0].CollateralMainchainAddress);
