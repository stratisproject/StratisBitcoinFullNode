...
namespace Stratis.Bitcoin.Features.PoA.Tests
{
    public class SlotsManagerTests
    {
        ...
        private Mock<ChainIndexer> chainIndexerMock;
        ...
        public SlotsManagerTests()
        {
            ...
            this.slotsManager = new SlotsManager(this.network, this.federationManager, this.chainIndexerMock.Object, new LoggerFactory());
        }
        ...
        public void GetMiningTimestamp()
        {
            ...
            this.slotsManager = new SlotsManager(this.network, fedManager, this.chainIndexerMock.Object, new LoggerFactory());
            ...
            this.chainIndexerMock.Setup(x => x.Tip).Returns(new ChainedHeader(new BlockHeader
            {
