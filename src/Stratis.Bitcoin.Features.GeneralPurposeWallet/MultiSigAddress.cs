...
{
	/// <summary>
	/// A multi-signature address; not derived from an HD seed.
	/// </summary>
	public class MultiSigAddress
	{
		...
		// TODO: Encrypt this address's private key with the wallet password
		/// <summary>
		/// This node's private key for this address. The other signatories will have their own. This is a
		/// required parameter so that the wallet can definitely perform partial signing for the multisig.
		/// It is not used during the creation of the redeem script etc.
		/// </summary>
		...
		*/
		...
		/// until the logic can be abstracted to work with any address type.
		/// </summary>
