...
namespace Stratis.Bitcoin.Features.LightWallet
{
    public class LightWalletSyncManager : IWalletSyncManager
    {
        ...
        public void Start()
        {
            ...
            {
                this.walletTip = this.chainIndexer.Get(this.walletManager.WalletTipHash);
        ...
        public void ProcessBlock(Block block)
        {
            ...
            ChainedHeader newTip = this.chainIndexer.Get(block.GetHash());
            if (newTip == null)
            {
            ...
            if (block.Header.HashPrevBlock != this.walletTip.HashBlock)
            {
                ...
                ChainedHeader inBestChain = this.chainIndexer.Get(this.walletTip.HashBlock);
                if (inBestChain == null)
                {
                    ...
                    while (this.chainIndexer.Get(fork.HashBlock) == null)
                        fork = fork.Previous;
        ...
        private void StartSync(int height)
        {
            ...
            ChainedHeader chainedHeader = this.chainIndexer.Get(height);
