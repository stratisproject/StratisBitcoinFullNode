    ...
    public class MemoryPoolTests
    {
        ...
        public void MempoolSyncTransactions()
        {
            using (NodeBuilder builder = NodeBuilder.Create())
            {
                ...
                // not in IBD
                stratisNodeSync.FullNode.BlockDownloadState.SetIsInitialBlockDownload(false, DateTime.UtcNow.AddMinutes(5));
                stratisNode1.FullNode.BlockDownloadState.SetIsInitialBlockDownload(false, DateTime.UtcNow.AddMinutes(5));
                stratisNode2.FullNode.BlockDownloadState.SetIsInitialBlockDownload(false, DateTime.UtcNow.AddMinutes(5));
