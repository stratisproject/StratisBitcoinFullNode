...
namespace Stratis.Bitcoin.IntegrationTests.EnvironmentMockUpHelpers
{
    ...
    public class StratisBitcoinPosRunner : INodeRunner
    {
        ...
        public void Start(string dataDir)
        {
            NodeSettings nodeSettings = new NodeSettings(InitStratisRegTest(), ProtocolVersion.ALT_PROTOCOL_VERSION, args:new string[] { "-conf=stratis.conf", "-datadir=" + dataDir });
        ...
        {
            NodeSettings nodeSettings = new NodeSettings(args:new string[] { $"-datadir={dir}", $"-stake={(staking ? 1 : 0)}", "-walletname=dummy", "-walletpassword=dummy" });
    ...
    public class StratisBitcoinPowRunner : INodeRunner
    {
        ...
        public void Start(string dataDir)
        {
            NodeSettings nodeSettings = new NodeSettings(args:new string[] { "-conf=bitcoin.conf", "-datadir=" + dataDir });
