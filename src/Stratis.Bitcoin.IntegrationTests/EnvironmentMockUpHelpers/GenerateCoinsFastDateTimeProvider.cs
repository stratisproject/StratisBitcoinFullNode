...
namespace Stratis.Bitcoin.IntegrationTests.EnvironmentMockUpHelpers
{
    ...
    public sealed class GenerateCoinsFastDateTimeProvider : SignalObserver<Block>, IDateTimeProvider
    {
        ...
        /// <summary>
        /// This gets called when the Transaction's time gets set in <see cref="Features.Miner.BlockDefinitionProofOfWork"/>.
        /// </summary>
        ...
        /// <summary>
        /// This gets called when the Block Header's time gets set in <see cref="Features.Miner.BlockDefinitionProofOfWork"/>.
        /// <para>
        /// Please see the <see cref="Features.Miner.BlockDefinitionProofOfWork.UpdateHeaders"/> method.
        /// </para>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// Please see the <see cref="Features.Miner.BlockDefinitionProofOfWork.CreateCoinbase"/> method.
        /// </para>
        /// </summary>
