...
namespace Stratis.Bitcoin.IntegrationTests
{
    public class CoinViewTester
    {
        ...
        public CoinViewTester(ICoinView coinView)
        {
            ...
            this.hash = coinView.GetTipHash().Result;
        }
        ...
        {
            FetchCoinsResponse result = this.coinView.FetchCoins(new[] { c.Outpoint.Hash }).Result;
        ...
        public uint256 NewBlock()
        {
            ...
            this.coinView.SaveChanges(this.pendingCoins, null, this.hash, newHash, this.blockHeight).Wait();
