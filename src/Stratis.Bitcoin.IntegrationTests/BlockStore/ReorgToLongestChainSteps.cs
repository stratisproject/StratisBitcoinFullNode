...
namespace Stratis.Bitcoin.IntegrationTests.BlockStore
{
    public partial class ReorgToLongestChainSpecification
    {
        ...
        {
            Transaction transaction = this.daveNode.FullNode.BlockStore().GetTransactionById(this.shorterChainTransaction.GetHash()).Result;
        ...
        {
            TestHelper.WaitLoop(() => this.bobNode.FullNode.BlockStore().GetTransactionById(this.shorterChainTransaction.GetHash()).Result == null, waitTimeSeconds: 300);
            this.bobNode.FullNode.BlockStore().GetTransactionById(this.shorterChainTransaction.GetHash()).Result
