...
namespace Stratis.Bitcoin.IntegrationTests
{
    public class ConsensusManagerFailedReorgTests
    {
        ...
        [Fact]
        public async Task ReorgChain_FailsFV_Reconnect_OldChain_ConnectedAsync()
        {
        ...
        [Fact]
        public async Task ReorgChain_FailsFV_Reconnect_OldChain_Nodes_DisconnectedAsync()
        {
            using (var builder = NodeBuilder.Create(this))
            {
                var bitcoinNoValidationRulesNetwork = new BitcoinRegTestNoValidationRules();
        ...
        [Fact]
        public async Task ReorgChain_FailsFV_Reconnect_OldChain_From2ndMiner_DisconnectedAsync()
        {
            using (var builder = NodeBuilder.Create(this))
            {
        ...
        [Fact]
        public async Task ReorgChain_FailsPartialValidation_ConnectedAsync()
        {
            using (var builder = NodeBuilder.Create(this))
            {
                var noValidationRulesNetwork = new BitcoinRegTestNoValidationRules();
        ...
        [Fact]
        public async Task ReorgChain_FailsPartialValidation_DisconnectedAsync()
        {
            using (var builder = NodeBuilder.Create(this))
            {
                var noValidationRulesNetwork = new BitcoinRegTestNoValidationRules();
        ...
        /// </summary>
        [Fact]
        public async Task ReorgChain_FailsFV_ChainHasBlocksAndHeadersOnly_DisconnectedAsync()
        {
            using (var builder = NodeBuilder.Create(this))
            {
                var noValidationRulesNetwork = new BitcoinRegTestNoValidationRules();
