    ...
    public sealed class SmartContractMinerTests
    {
        ...
        public class TestContext
        {
            ...
            public async Task InitializeAsync([CallerMemberName] string callingMethod = "")
            {
                ...
                this.mempool = new TxMempool(dateTimeProviderSet, new BitcoinBlockPolicyEstimator(this.loggerFactory, this.NodeSettings), this.loggerFactory, this.NodeSettings);
