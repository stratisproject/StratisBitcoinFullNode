...
namespace Stratis.SmartContracts.CLR.Validation
{
    public static class FormatPolicy
    {
        ...
        public static ValidationPolicy Default = new ValidationPolicy()
            ...
            .TypeDefValidator(new StaticConstructorValidator(), t => t.IsContractType(), NestedTypePolicy.Ignore)
            .TypeDefValidator(new GenericTypeValidator(), t => t.IsContractType())
            .TypeDefValidator(new NamespaceValidator(), t => t.IsContractType())
            .TypeDefValidator(new SingleConstructorValidator(), t => t.IsContractType(), NestedTypePolicy.Ignore)
            .TypeDefValidator(new ConstructorParamValidator(), t => t.IsContractType(), NestedTypePolicy.Ignore)
            .TypeDefValidator(new InheritsSmartContractValidator(), t => t.IsContractType(), NestedTypePolicy.Ignore)
            .TypeDefValidator(new FieldDefinitionValidator(), t => t.IsContractType(), NestedTypePolicy.Ignore)
