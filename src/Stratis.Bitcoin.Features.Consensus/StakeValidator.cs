...
{
    /// <summary>
    /// Provides functions for checking validity of PoS blocks.
    /// </summary>
    /// <remarks>
    /// One of them is <see cref="ComputeStakeModifierV2"/> is used for calculating Stake Modifier (hash modifier of proof-of-stake):
    ...
    public class StakeValidator
    {
        ...
        public void CheckProofOfStake(ContextInformation context, ChainedBlock prevChainedBlock, BlockStake prevBlockStake, Transaction transaction, uint headerBits)
        {
            ...
            // Kernel (input 0) must match the stake hash target per coin age (headerBits).
