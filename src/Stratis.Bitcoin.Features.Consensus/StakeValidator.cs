...
namespace Stratis.Bitcoin.Features.Consensus
{
    ...
    public class StakeValidator
    {
        ...
        /// <summary>Cheain of headers.</summary>
        private readonly ConcurrentChain chain;
        /// <summary>Used for getting UTXOs.</summary>
        private readonly CoinView coinView;
        /// <summary>Used to get minimum number of confirmations that is required for staking.</summary>
        ...
        /// <summary>
        /// Checks if provided <see cref="tx"/> is a valid coinstake transaction.
        /// </summary>
        ...
        /// The purpose of stake modifier is to prevent a txout (coin) owner from computing future proof-of-stake
        /// generated by this txout at the time of transaction confirmation. To meet kernel protocol, the txout
        ...
        /// <summary>
        /// Stratis kernel protocol. Checks the stake kernel hash.
        /// </summary>
        /// <remarks>
        ...
        /// <list type="number">
        /// <item>stakeModifierV2: Scrambles computation to make it very difficult to precompute future proof-of-stake.</item>
        /// <item>stakingCoins.Time: Time of the coinstake UTXO. Slightly scrambles computation.</item>
        /// <item>prevout.Hash: Hash of stakingCoins UTXO, to reduce the chance of nodes generating coinstake at the same time.</item>
        /// <item>prevout.N: Output number of stakingCoins UTXO, to reduce the chance of nodes generating coinstake at the same time.</item>
        /// <item>transactionTime: Timestamp of the coinstake transaction.</item>
        /// </list>
