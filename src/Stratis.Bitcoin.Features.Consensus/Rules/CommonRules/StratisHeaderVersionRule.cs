...
namespace Stratis.Bitcoin.Features.Consensus.Rules.CommonRules
{
    ...
    public class StratisHeaderVersionRule : HeaderVersionRule
    {
        ...
        public override Task RunAsync(RuleContext context)
        {
            ...
            {
                this.Logger.LogTrace("(-)[BAD_VERSION_LOW]");
            ...
            // block versions between 7 and 0x20000000.
            if ((chainedHeader.Header.Version > 7) && (chainedHeader.Header.Version < ThresholdConditionCache.VersionbitsTopBits))
            {
