...
namespace Stratis.Bitcoin.Features.Consensus.Rules.CommonRules
{
    public class SaveCoinviewRule : UtxoStoreConsensusRule
    {
        ...
        public override async Task RunAsync(RuleContext context)
        {
            ...
            await this.PowParent.UtxoSet.SaveChanges(utxoRuleContext.UnspentOutputSet.GetCoins(), null, oldBlockHash, nextBlockHash, height).ConfigureAwait(false);
            ...
            if (this.PowParent.UtxoSet is CachedCoinView cachedCoinView)
                await cachedCoinView.Flush(false).ConfigureAwait(false);
        }
    }
    ...
    public class LoadCoinviewRule : UtxoStoreConsensusRule
    {
        ...
        public override async Task RunAsync(RuleContext context)
        {
            ...
            FetchCoinsResponse coins = await this.PowParent.UtxoSet.FetchCoins(ids).ConfigureAwait(false);
