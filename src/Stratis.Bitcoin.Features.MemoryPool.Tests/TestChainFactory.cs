...
namespace Stratis.Bitcoin.Features.MemoryPool.Tests
{
    ...
    internal class TestChainFactory
    {
        ...
        public static async Task<ITestChainContext> CreateAsync(Network network, Script scriptPubKey, string dataDir)
        {
            ...
            ConsensusRules consensusRules = new ConsensusRules(network, loggerFactory, dateTimeProvider, chain, new NodeDeployments(network, chain)).Register(new FullNodeBuilderConsensusExtension.BaseConsensusRules());
