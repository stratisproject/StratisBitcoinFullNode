...
using static Stratis.Bitcoin.Features.Miner.BlockDefinitionProofOfWork;

namespace Stratis.Bitcoin.Features.Miner
{
    /// <summary>
    /// Base class that defines how a block is constructed.
    /// </summary>
    public abstract class BlockDefinition
    {
        ...
        /// <summary>Assembler options specific to the assembler e.g. <see cref="BlockBuilderOptions.BlockMaxSize"/>.</summary>
        protected BlockBuilderOptions Options;
            ...
            BlockBuilderOptions options = null)
        {
            ...
            this.Options = options ?? new BlockBuilderOptions();
