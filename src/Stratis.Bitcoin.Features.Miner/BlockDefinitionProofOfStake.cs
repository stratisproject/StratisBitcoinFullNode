...
{
    /// <summary>
    /// Defines how proof of stake blocks gets built.
    /// </summary>
    public class BlockDefinitionProofOfStake : BlockDefinition
    {
        ...
        public BlockDefinitionProofOfStake(
            ...
            : base(consensusLoop, dateTimeProvider, loggerFactory, mempool, mempoolLock, network, new BlockBuilderOptions() { IsProofOfStake = true })
        {
