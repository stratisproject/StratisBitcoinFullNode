...
namespace Stratis.Bitcoin.Features.Miner
{
    public class PosBlockDefinition : BlockDefinition
    {
        ...
        public PosBlockDefinition(
            ...
            : base(consensusLoop, dateTimeProvider, loggerFactory, mempool, mempoolLock, network, new BlockDefinitionOptions(network))
        {
        ...
        public override void UpdateHeaders()
        {
            ...
            this.block.Header.Bits = this.stakeValidator.GetNextTargetRequired(this.stakeChain, this.ChainTip, this.Network.Consensus, this.Network.Consensus.IsProofOfStake);
