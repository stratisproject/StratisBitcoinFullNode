...
namespace Stratis.Bitcoin.Features.Notifications.Tests
{
    public class BlockNotificationTest : LogsTestBase
    {
        ...
        public void Notify_Completes_StartHashNotSet()
        {
            ...
            this.signals.Verify(s => s.TriggerBlockConnected(It.IsAny<ChainedHeaderBlock>()), Times.Exactly(0));
        }
        ...
        public void Notify_WithSync_RunsAndBroadcastsBlocks()
        {
            ...
            this.signals.Verify(s => s.TriggerBlockConnected(It.IsAny<ChainedHeaderBlock>()), Times.Exactly(2));
        }
        ...
        public void Notify_Reorg_PushesPullerBackToForkPoint_SignalsNewLookaheadResult()
        {
            ...
            this.signals.Setup(s => s.TriggerBlockConnected(It.Is<ChainedHeaderBlock>(b => b.Block.GetHash() == blocks[0].GetHash())))
                .Callback(() =>
                {
                    source.Cancel();
                }).Verifiable();
