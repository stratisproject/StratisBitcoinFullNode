...
namespace Stratis.Bitcoin.Features.SmartContracts.Models
{
    public class ReceiptResponse
    {
        ...
        public ReceiptResponse(Receipt receipt, Network network)
        {
            ...
            this.From = receipt.From.ToAddress().ToString();
            this.To = receipt.To?.ToAddress().ToString();
            this.NewContractAddress = receipt.NewContractAddress?.ToAddress().ToString();
    ...
    public class LogResponse
    {
        ...
        {
            this.Address = log.Address.ToAddress().ToString();
