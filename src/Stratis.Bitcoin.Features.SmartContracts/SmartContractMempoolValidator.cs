...
namespace Stratis.Bitcoin.Features.SmartContracts
{
    ...
    public class SmartContractMempoolValidator : MempoolValidator
    {
        ...
        public SmartContractMempoolValidator(ITxMempool memPool, MempoolSchedulerLock mempoolLock,
            ...
            IEnumerable<IContractTransactionFullValidationRule> txFullValidationRules, NodeDeployments nodeDeployments)
            : base(memPool, mempoolLock, dateTimeProvider, mempoolSettings, chainIndexer, coinView, loggerFactory, nodeSettings, consensusRules, nodeDeployments)
        {
