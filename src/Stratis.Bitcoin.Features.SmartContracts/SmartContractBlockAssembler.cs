...
namespace Stratis.Bitcoin.Features.SmartContracts
{
    public class SmartContractBlockAssembler : PowBlockAssembler
    {
        ...
        private void AddContractToBlock(TxMempoolEntry mempoolEntry, TxOut smartContractTxOut)
        {
            ...
            SmartContractExecutor executor = SmartContractExecutor.InitializeForBlockAssembler(carrier, this.decompiler, this.gasInjector, mempoolEntry.Fee, this.network, this.stateSnapshot, this.validator, this.keyEncodingStrategy);
