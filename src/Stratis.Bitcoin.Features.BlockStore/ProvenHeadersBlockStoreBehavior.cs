...
namespace Stratis.Bitcoin.Features.BlockStore
{
    ...
    public class ProvenHeadersBlockStoreBehavior : BlockStoreBehavior
    {
        ...
        public ProvenHeadersBlockStoreBehavior(Network network, IChainState chainState, ILoggerFactory loggerFactory, IConsensusManager consensusManager, ICheckpoints checkpoints, IBlockStoreQueue blockStoreQueue)
            : base(chainState, loggerFactory, consensusManager, blockStoreQueue)
        {
        ...
        {
            var res = new ProvenHeadersBlockStoreBehavior(this.network, this.chainState, this.loggerFactory, this.consensusManager, this.checkpoints, this.blockStoreQueue)
            {
