    ...
    public class PosBlockAssemblerTest : LogsTestBase
    {
        ...
        public void CreateNewBlock_WithScript_DoesNotValidateTemplateUsingRuleContext()
        {
            ...
            this.ExecuteWithConsensusOptions(newOptions, () =>
            {
                ...
                this.consensusLoop.Verify(c => c.ConsensusRules.PartialValidationAsync(It.IsAny<ChainedHeaderBlock>()), Times.Exactly(0));
        ...
        private void SetupConsensusLoop()
        {
            ...
            this.consensusLoop.Setup(c => c.ConsensusRules.PartialValidationAsync(It.IsAny<ChainedHeaderBlock>()))
