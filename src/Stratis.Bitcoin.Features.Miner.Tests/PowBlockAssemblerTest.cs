    ...
    public class PowBlockAssemblerTest : LogsTestBase
    {
        ...
        public void CreateNewBlock_WithScript_ReturnsBlockTemplate()
        {
            this.ExecuteWithConsensusOptions(new PowConsensusOptions(), () =>
            {
                ...
                var powBlockAssembler = new PowBlockAssembler(this.dateTimeProvider.Object, this.LoggerFactory.Object, this.txMempool.Object, new MempoolSchedulerLock(), this.network);

                var blockTemplate = powBlockAssembler.Configure(this.consensusLoop.Object).Build(chain.Tip, this.key.ScriptPubKey);
        ...
        public void ComputeBlockVersion_UsingChainTipAndConsensus_NoBip9DeploymentActive_UpdatesHeightAndVersion()
        {
            this.ExecuteWithConsensusOptions(new PowConsensusOptions(), () =>
            {
                ...
                var powBlockAssembler = new PowTestBlockAssembler(this.dateTimeProvider.Object, this.LoggerFactory.Object, this.txMempool.Object, new MempoolSchedulerLock(), this.network);
        ...
        public void ComputeBlockVersion_UsingChainTipAndConsensus_Bip9DeploymentActive_UpdatesHeightAndVersion()
        {
            ...
            try
            {
                ...
                var powBlockAssembler = new PowTestBlockAssembler(this.dateTimeProvider.Object, this.LoggerFactory.Object, this.txMempool.Object,
        ...
        public void TestBlockValidity_UsesRuleContextToValidateBlock()
        {
            ...
            this.ExecuteWithConsensusOptions(newOptions, () =>
            {
                ...
                var powBlockAssembler = new PowTestBlockAssembler(this.dateTimeProvider.Object, this.LoggerFactory.Object, this.txMempool.Object, new MempoolSchedulerLock(), this.network);
                powBlockAssembler.Configure(this.consensusLoop.Object);
        ...
        private class PowTestBlockAssembler : PowBlockAssembler
        {
            public PowTestBlockAssembler(
                ...
                : base(dateTimeProvider, loggerFactory, mempool, mempoolLock, network, options)
            {
