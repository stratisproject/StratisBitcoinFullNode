...
namespace Stratis.Bitcoin.Features.SmartContracts.Tests.Consensus.Rules
{
    public class AllowedScriptTypesRuleTest
    {
        ...
        private readonly AllowedScriptTypesRule rule;
        ...
        public AllowedScriptTypesRuleTest()
        {
            ...
            this.rule = new AllowedScriptTypesRule
            {
        ...
        // TODO: Tests for P2SH. How to generate the correct ScriptSigs and ScriptPubKeys?
