...
namespace Stratis.Bitcoin.Features.SmartContracts.Tests
{
    public class ContractTransferProcessorTests
    {
        ...
        public void NoBalance_TxValue1_TransferValue1()
        {
            ...
            Assert.Equal(receiverAddress.ToAddressString(this.network), output1Address);
        ...
        public void HasBalance_TxValue1_TransferValue1()
        {
            ...
            Assert.Equal(receiverAddress.ToAddressString(this.network), output2Address);
        ...
        public void Transfers_Summed_Correctly()
        {
            ...
            Assert.Equal(thirdAddress.ToAddressString(this.network), output3Address);
        ...
        public void Create_Refund()
        {
            ...
            Assert.Equal(txContextMock.Object.Sender.ToAddressString(this.network), outputAddress);
