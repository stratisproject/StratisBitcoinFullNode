...
namespace Stratis.Bitcoin.Features.SmartContracts.Tests
{
    public class SmartContractCompilerTests
    {
        ...
        public void SmartContract_ReferenceResolver_HasCorrectAssemblies()
        {
            ...
            Assert.Contains(allowedAssemblies, a => a.GetName().Name == "Stratis.SmartContracts.ByteHelper");
        }

        [Fact]
        public void SmartContract_Compiler_SuccessWithAllowedAssemblies()
        {
            SmartContractCompilationResult result = SmartContractCompiler.CompileFile("SmartContracts/AllowedAssemblies.cs");
