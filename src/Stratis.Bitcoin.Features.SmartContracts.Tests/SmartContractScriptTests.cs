...
namespace Stratis.Bitcoin.Features.SmartContracts.Tests
{
    public class SmartContractScriptTests
    {
        ...
        {
            var script = new NBitcoin.Script(new [] {(byte) ScOpcodeType.OP_CALLCONTRACT});
        ...
        {
            var script = new NBitcoin.Script(new[] { (byte)ScOpcodeType.OP_CREATECONTRACT });
        ...
        {
            var script = new NBitcoin.Script(new[] { (byte)ScOpcodeType.OP_SPEND });
        ...
        {
            var script = new NBitcoin.Script(new[] { (byte)ScOpcodeType.OP_INTERNALCONTRACTTRANSFER });
