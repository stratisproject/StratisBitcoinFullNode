...
namespace Stratis.Bitcoin.Features.SmartContracts.Tests
{
    public sealed class SmartContractTransactionExecutorTests
    {
        ...
        public void ExecuteCallContract_Fails_ReturnFundsToSender()
        {
            ...
            var executor = new SmartContractTransactionExecutor(this.stateRepository, this.decompiler, new SmartContractValidator(new ISmartContractValidator[] { }), this.gasInjector, deserializedCall, 0, 0, deserializedCall.ContractAddress, this.network);
