...
namespace Stratis.Bitcoin.Features.SmartContracts.Tests
{
    public sealed class SmartContractTransactionExecutorTests
    {
        ...
        public void ExecuteCallContract_Fails_ReturnFundsToSender()
        {
            ...
            var executor = SmartContractExecutor.Initialize(deserializedCall, this.network, this.stateRepository, new SmartContractValidator(new IValidator[] { }), this.keyEncodingStrategy, this.loggerFactory, new Money(10000));
        ...
        public void ExecuteCreateContract_ValidationFails_RefundGas_MempoolFeeLessGas()
        {
            ...
            this.stateRepository.SetCode(new uint160(1), contractExecutionCode);
            var validator = new SmartContractValidator(new IValidator[] { new SmartContractDeterminismValidator() });
        ...
        public void Executor_Contract_DoesNotExist_Refund()
        {
            ...
            var executor = new CallSmartContract(carrier, this.keyEncodingStrategy, this.loggerFactory, new Money(10000000), this.network, state, new SmartContractValidator(new IValidator[] { }));
        ...
        public void Execute_InterContractCall_InfiniteLoop_AllGasConsumed()
        {
            ...
            validator = new SmartContractValidator(new IValidator[] { new SmartContractDeterminismValidator() });
