...
namespace Stratis.Bitcoin.Features.SmartContracts.Tests
{
    public sealed class SmartContractResultRefundProcessorTests
    {
        ...
        public void ContractExecutionResult_RefundDue_AdjustFee()
        {
            ...
            (var fee, var refunds) = this.refundProcessor.Process(carrier.ContractTransactionData, new Money(10500), carrier.Sender, (Gas)950, null);
        ...
        public void ContractExecutionResult_NoRefundDue_NoFeeAdjustment()
        {
            ...
            (var fee, var refunds) = this.refundProcessor.Process(carrier.ContractTransactionData, new Money(10500), carrier.Sender, (Gas)5000, null);
        ...
        public void ContractExecutionResult_OutOfGasException_NoRefundDue_NoFeeAdjustment()
        {
            ...
            (var fee, var refunds) = this.refundProcessor.Process(carrier.ContractTransactionData, new Money(10500), carrier.Sender, (Gas)5000, new OutOfGasException());
