...
//        private readonly Mock<IStateProcessor> stateProcessor;
...
//            var state = new State(this.contractStateRoot.Object,
//                this.block,
//                this.network,
//                0,
//                transactionHash,
...
//        //            // This section mocks the behaviour of the ITE
//        //            IState newState = state.Snapshot();
//        //            StateTransitionResult nestedResult = newState.Apply(stateinternalCreateMessage);
...
//            StateTransitionResult result = this.stateProcessor.Apply(state, externalCreateMessage);
