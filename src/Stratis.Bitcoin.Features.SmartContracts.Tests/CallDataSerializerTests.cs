...
namespace Stratis.Bitcoin.Features.SmartContracts.Tests
{
    public sealed class CallDataSerializerTests
    {
        ...
        public void SmartContract_CanSerialize_OP_CREATECONTRACT_WithMethodParameters()
        {
            ...
            var contractTxData = new ContractTxData(1, 1, (Gas)5000, contractExecutionCode, methodParamSerializer.ToRaw(methodParameters));
        ...
        public void SmartContract_CanSerialize_OP_CALLCONTRACT_WithMethodParameters()
        {
            ...
            var contractTxData = new ContractTxData(1, 1, (Gas)5000, 100, "Execute", methodParamSerializer.ToRaw(methodParameters));
            var callDataResult = serializer.Deserialize(serializer.Serialize(contractTxData));
            var callData = callDataResult.Value;
