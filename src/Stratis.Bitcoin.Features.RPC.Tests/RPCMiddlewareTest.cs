...
namespace Stratis.Bitcoin.Features.RPC.Tests
{
    public class RPCMiddlewareTest : LogsTestBase
    {
        ...
        public RPCMiddlewareTest()
        {
            ...
            this.middleware = new RPCMiddleware(this.delegateContext.Object, this.authorization.Object, this.LoggerFactory.Object, new Mock<IHttpContextFactory>().Object, new FullNode());
        }
