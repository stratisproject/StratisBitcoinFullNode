...
namespace Stratis.Bitcoin.Features.FederationWallet.Tests
{
    public class MultiSigTests
    {
	 ...
	 //   {
		...
		//		var gwm1 = node1.FullNode.NodeService<IFederationWalletManager>() as FederationWalletManager;

		//	    gwm1.CreateWallet("Multisig1", "multisig");

		//		var gwallet1 = gwm1.GetWalletByName("multisig");
		//		var gaccount1 = gwallet1.GetAccountsByCoinType((Stratis.Bitcoin.Features.FederationWallet.CoinType)node1.FullNode.Network.Consensus.CoinType).First();
	 ...
	 //   {
		...
		//		var gwth1 = node1.FullNode.NodeService<IFederationWalletTransactionHandler>() as FederationWalletTransactionHandler;
		...
		//		var multiSigContext = new Stratis.Bitcoin.Features.FederationWallet.TransactionBuildContext(
		//			new FederationWalletAccountReference("multisig", "account 0"),
		//			new[] { new Stratis.Bitcoin.Features.FederationWallet.Recipient { Amount = Money.Coins(5m), ScriptPubKey = arbitraryDestination } }.ToList(),
		//			"Multisig1")
		//		{
		//			TransactionFee = Money.Coins(0.01m),
		...
		//				(Stratis.Bitcoin.Features.FederationWallet.CoinType)node1.FullNode.Network.Consensus.CoinType).First();

		//		gaccount1.ImportMultiSigAddress(multiSig.multiSigAddress);

		//		var gwth1 =
		//			node1.FullNode.NodeService<IFederationWalletTransactionHandler>() as FederationWalletTransactionHandler;
		...
		//			new[]
		//			{
		//				new Stratis.Bitcoin.Features.FederationWallet.Recipient
		//				{
