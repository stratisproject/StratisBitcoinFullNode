...
namespace Stratis.Bitcoin.Features.MemoryPool
{
    ...
    public static class MempoolErrors
    {
        ...
        /// <summary>'mempool-tx-totalout-less-than-minrelay-fee' error returns a <see cref="RejectInvalid"/> reject code.</summary>
        public static MempoolError TxTotalOutLessThanMinRelayFee = new MempoolError(RejectInvalid, "mempool-tx-totalout-less-than-minrelay-fee");
    }
}
