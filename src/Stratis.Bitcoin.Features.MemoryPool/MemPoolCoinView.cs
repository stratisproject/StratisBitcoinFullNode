...
namespace Stratis.Bitcoin.Features.MemoryPool
{
    ...
    public class MempoolCoinView : ICoinView, IBackedCoinView
    {
        ...
        /// <inheritdoc />
        public Task SaveChanges(IList<UnspentOutputs> unspentOutputs, IEnumerable<TxOut[]> originalOutputs, uint256 oldBlockHash,
        ...
        public async Task LoadViewAsync(Transaction trx)
        {
            ...
            FetchCoinsResponse coins = await this.Inner.FetchCoins(ids.ToArray());
