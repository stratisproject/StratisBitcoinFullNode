...
namespace Stratis.Bitcoin.Features.SmartContracts.Wallet
{
    ...
    /// </remarks>
    public class ContractSentTransactionItemModelComparer : IEqualityComparer<ContractTransactionItemModel>
    {
        /// <summary>
        ...
        public bool Equals(ContractTransactionItemModel x, ContractTransactionItemModel y)
        {
            if (x == null && y == null)
                return true;
        ...
        public int GetHashCode(ContractTransactionItemModel obj)
        {
            if (obj == null)
