...
namespace Stratis.Bitcoin.Features.ColdStaking.Tests
{
    ...
    public class ColdStakingControllerTest : TestBase
    {
        ...
        private ConsensusChainIndexer consensusChainIndexer;
        ...
        private void CreateMempoolManager()
        {
            ...
            ConsensusRuleEngine consensusRuleEngine = new PosConsensusRuleEngine(this.Network, this.loggerFactory, this.dateTimeProvider,
                this.consensusChainIndexer, this.nodeDeployments, this.consensusSettings, checkpoints.Object, this.coinView.Object, this.stakeChain.Object,
            ...
            var mempoolValidator = new MempoolValidator(this.txMemPool, mempoolLock, this.dateTimeProvider, this.mempoolSettings, this.consensusChainIndexer,
        ...
        private void Initialize([System.Runtime.CompilerServices.CallerMemberName] string callingMethod = "")
        {
            ...
            this.coldStakingManager = new ColdStakingManager(this.Network, new ConsensusChainIndexer(this.Network), walletSettings, this.nodeSettings.DataFolder,
