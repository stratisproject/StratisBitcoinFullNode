...
{
    public sealed class PosTestNetwork : Network
    {
        public PosTestNetwork()
        {
            ...
            this.RootFolderName = TestNetwork.StratisRootFolderName;
            this.DefaultConfigFilename = TestNetwork.StratisDefaultConfigFilename;
            ...
            this.MaxTipAge = TestNetwork.StratisDefaultMaxTipAgeInSeconds;
            ...
            this.Genesis = TestNetwork.CreateGenesis(consensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward);
