...
namespace Stratis.Bitcoin.Tests.Builder
{
    public class FullNodeFeatureExecutorTest
    {
        ...
        public void StartCallsStartOnEachFeatureRegisterdWithFullNode()
        {
            ...
            this.feature.Verify(f => f.InitializeAsync().GetAwaiter().GetResult(), Times.Exactly(1));
            this.feature2.Verify(f => f.InitializeAsync().GetAwaiter().GetResult(), Times.Exactly(1));
        }
        ...
        public void StartFeaturesThrowExceptionsCollectedInAggregateException()
        {
            ...
            {
                this.feature.Setup(f => f.InitializeAsync().GetAwaiter().GetResult())
                    .Throws(new ArgumentNullException());
                this.feature2.Setup(f => f.InitializeAsync().GetAwaiter().GetResult())
                    .Throws(new ArgumentNullException());
