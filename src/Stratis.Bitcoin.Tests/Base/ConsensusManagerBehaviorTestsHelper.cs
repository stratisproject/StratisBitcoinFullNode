...
namespace Stratis.Bitcoin.Tests.Base
{
    public class ConsensusManagerBehaviorTestsHelper
    {
            ...
            Func<List<BlockHeader>, bool, ConnectNewHeadersResult> connectNewHeadersMethod = null)
        {
            ...
            connectionManagerMock.SetupGet(x => x.ConnectionSettings).Returns(new ConnectionManagerSettings(new NodeSettings(StratisNetworks.StratisMain)));
        ...
        private Mock<INetworkPeer> CreatePeerMock()
        {
            ...
            var connection = new NetworkPeerConnection(StratisNetworks.StratisMain, peer.Object, new TcpClient(), 0, (message, token) => Task.CompletedTask,
            ...
            VersionPayload version = connectionParameters.CreateVersion(new IPEndPoint(1, 1), StratisNetworks.StratisMain, new DateTimeProvider().GetTimeOffset());
