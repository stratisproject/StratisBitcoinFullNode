...
namespace Stratis.Bitcoin.Tests.P2P
{
    public sealed class PeerConnectorTests : TestBase
    {
        ...
        public void PeerConnectorAddNode_ConnectsTo_AddNodePeers()
        {
            ...
            networkPeerFactory.Setup(npf => npf.CreateConnectedNetworkPeerAsync(It.IsAny<IPEndPoint>(), It.IsAny<NetworkPeerConnectionParameters>(), It.IsAny<Action<INetworkPeer>>())).Returns(Task.FromResult(networkPeer.Object));
