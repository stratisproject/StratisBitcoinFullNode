...
namespace Stratis.Bitcoin.Tests.P2P
{
    public sealed class PeerAddressManagerBehaviourTests : TestBase
    {
        ...
        public PeerAddressManagerBehaviourTests()
        {
            ...
            this.networkPeerFactory = new NetworkPeerFactory(this.network, DateTimeProvider.Default, this.extendedLoggerFactory, new PayloadProvider().DiscoverPayloads(), new SelfEndpointTracker(new DateTimeProvider()));
        }
