...
namespace Stratis.Bitcoin.Tests.Consensus
{
    public class CheckPointsTest
    {
        ...
        {
            var checkpoints = new Checkpoints(this.network, new ConsensusSettings() { UseCheckpoints = false });
        ...
        {
            var checkpoints = new Checkpoints(this.network, new ConsensusSettings() { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(NetworkContainer.TestNet, new ConsensusSettings() { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(NetworkContainer.RegTest, new ConsensusSettings() { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(NetworkContainer.StratisMain, new ConsensusSettings() { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(NetworkContainer.StratisTest, new ConsensusSettings() { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(NetworkContainer.StratisRegTest, new ConsensusSettings() { UseCheckpoints = true });
