...
namespace Stratis.Bitcoin.Tests.Consensus
{
    public class CheckPointsTest
    {
        ...
        {
            var checkpoints = new Checkpoints(NBitcoin.Networks.TestNet, new ConsensusSettings() { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(NBitcoin.Networks.RegTest, new ConsensusSettings() { UseCheckpoints = true });
