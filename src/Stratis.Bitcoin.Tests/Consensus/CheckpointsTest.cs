...
namespace Stratis.Bitcoin.Tests.Consensus
{
    public class CheckPointsTest
    {
        ...
        {
            var checkpoints = new Checkpoints(Network.Main, new ConsensusSettings(new NodeSettings()) { UseCheckpoints = false });
        ...
        {
            var checkpoints = new Checkpoints(Network.Main, new ConsensusSettings(new NodeSettings()) { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(Network.TestNet, new ConsensusSettings(new NodeSettings()) { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(Network.RegTest, new ConsensusSettings(new NodeSettings()) { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(Network.StratisMain, new ConsensusSettings(new NodeSettings()) { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(Network.StratisTest, new ConsensusSettings(new NodeSettings()) { UseCheckpoints = true });
        ...
        {
            var checkpoints = new Checkpoints(Network.StratisRegTest, new ConsensusSettings(new NodeSettings()) { UseCheckpoints = true });
        ...
        {
            var consensusSettings = new ConsensusSettings(new NodeSettings()) { UseCheckpoints = false };
