...
namespace Stratis.Bitcoin.Features.BlockStore.Tests.LoopTests
{
    ...
    internal class FluentBlockStoreLoop : IDisposable
    {
        ...
        private void ConfigureConnectionManager()
        {
            ...
            this.connectionManager.Setup(c => c.NodeSettings).Returns(new NodeSettings(args: new string[] { $"-datadir={this.dataFolder.WalletPath}" }, loadConfiguration:true));
        ...
        internal void Create(ConcurrentChain chain)
        {
            ...
            this.Loop = new BlockStoreLoop(
                    ...
                    new StoreSettings(new NodeSettings(args:new string[] { $"-datadir={this.dataFolder.WalletPath}" }, loadConfiguration:true)),
