...
namespace Stratis.SmartContracts.ContractValidation
{
    internal class ContractAnalyzer
    {
        ...
        private IList<IContractValidator> _validators;
        ...
        public ContractAnalyzer(byte[] contractCode, string contractName)
        {
            ...
            _validators = new List<IContractValidator>
            {
                new ContractFormatValidator(_moduleDefinition, _contractType),
                new DeterminismValidator(_contractType)
            };
        ...
        {
            var endResult = new ContractValidationResult();
