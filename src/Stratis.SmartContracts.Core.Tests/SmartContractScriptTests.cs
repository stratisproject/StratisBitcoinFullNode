...
namespace Stratis.SmartContracts.Core.Tests
{
    public class SmartContractScriptTests
    {
        ...
        {
            var script = new Bitcoin.NBitcoin.Script(new byte[] {(byte) ScOpcodeType.OP_CALLCONTRACT});
        ...
        {
            var script = new Bitcoin.NBitcoin.Script(new byte[] { 0xFF, (byte)ScOpcodeType.OP_CALLCONTRACT, 0xFF });
        ...
        {
            var script = new Bitcoin.NBitcoin.Script(new byte[] { (byte)ScOpcodeType.OP_CREATECONTRACT });
        ...
        {
            var script = new Bitcoin.NBitcoin.Script(new byte[] { 0xFF, (byte)ScOpcodeType.OP_CREATECONTRACT, 0xFF });
        ...
        {
            var script = new Bitcoin.NBitcoin.Script(new byte[] { (byte)ScOpcodeType.OP_SPEND });
        ...
        {
            var script = new Bitcoin.NBitcoin.Script(new byte[] { 0xFF, (byte)ScOpcodeType.OP_SPEND, 0xFF });
        ...
        {
            var script = new Bitcoin.NBitcoin.Script(new byte[] { (byte)ScOpcodeType.OP_INTERNALCONTRACTTRANSFER });
        ...
        {
            var script = new Bitcoin.NBitcoin.Script(new byte[] { 0xFF, (byte)ScOpcodeType.OP_INTERNALCONTRACTTRANSFER, 0xFF });
