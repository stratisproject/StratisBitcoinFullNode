    ...
    public class WalletTransactionHandlerTest : LogsTestBase
    {
        ...
        public void BuildTransactionNoSpendableTransactionsThrowsWalletException()
        {
            Assert.Throws<WalletException>(() =>
            {
                ...
                var walletManager = new WalletManager(this.blockStore, this.LoggerFactory.Object, this.Network, chain, new WalletSettings(nodeSettings),
        ...
        public void Given_GetMaximumSpendableAmountIsCalled_When_ThereAreNoSpendableFound_Then_MaxAmountReturnsAsZero()
        {
            ...
            var walletManager = new WalletManager(this.blockStore, this.LoggerFactory.Object, this.Network, new ChainIndexer(this.Network), new WalletSettings(NodeSettings.Default(this.Network)),
        ...
        private WalletTransactionHandlerTestContext SetupWallet()
        {
            ...
            var walletManager = new WalletManager(this.blockStore, this.LoggerFactory.Object, this.Network, chain,
