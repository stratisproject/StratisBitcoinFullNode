    ...
    public class WalletTransactionHandlerTest : LogsTestBase
    {
        ...
        public void BuildTransactionNoSpendableTransactionsThrowsWalletException()
        {
            Assert.Throws<WalletException>(() =>
            {
                ...
                var chain = new ConsensusChainIndexer(this.Network, new ChainedHeader(blockHeader, blockHeader.GetHash(), 1));
        ...
        public void Given_GetMaximumSpendableAmountIsCalled_When_ThereAreNoSpendableFound_Then_MaxAmountReturnsAsZero()
        {
            ...
            var walletManager = new WalletManager(this.LoggerFactory.Object, this.Network, new ConsensusChainIndexer(this.Network), new WalletSettings(NodeSettings.Default(this.Network)),
