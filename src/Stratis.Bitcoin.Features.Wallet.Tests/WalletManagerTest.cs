...
namespace Stratis.Bitcoin.Features.Wallet.Tests
{
    public class WalletManagerTest : LogsTestBase, IClassFixture<WalletFixture>
    {
        ...
        public WalletManagerTest(WalletFixture walletFixture)
        {
            ...
            this.chain = new ConcurrentChain(Network.Main);
        ...
        public void UpdateLastBlockSyncedHeightWhileWalletCreatedDoesNotThrowInvalidOperationException()
        {
            ...
            loggerFactory.Setup(l => l.CreateLogger(It.IsAny<string>())).Returns(new Mock<ILogger>().Object);
            ...
            var concurrentChain = new ConcurrentChain(Network.Main, Network.Main.GetGenesis().Header);
        ...
        public void LoadWalletWithExistingWalletLoadsWalletOntoManager()
        {
            ...
            var walletManager = new WalletManager(this.LoggerFactory.Object, Network.StratisMain, this.chain, NodeSettings.Default(), new Mock<WalletSettings>().Object,
                                                dataFolder, new Mock<IWalletFeePolicy>().Object, new Mock<IAsyncLoopFactory>().Object, new NodeLifetime(), DateTimeProvider.Default);
        ...
        {
            var concurrentchain = new ConcurrentChain(this.network, this.network.GetGenesis().Header);
        ...
        public void ProcessBlockWithWalletTipBlockNotOnChainYetThrowsWalletException()
        {
            Assert.Throws<WalletException>(() =>
            {
                ...
                var chain = new ConcurrentChain(wallet.Network, wallet.Network.GetGenesis().Header);
        ...
        private WalletManager GetWalletManagerWithCustomConfigParam(DataFolder dataFolder, params string[] cmdLineArgs)
        {
            ...
            return new WalletManager(this.LoggerFactory.Object, this.network, new ConcurrentChain(Network.Main, Network.Main.GetGenesis().Header),
