...
namespace Stratis.Bitcoin.Features.Wallet.Tests
{
    public class WalletManagerTest : LogsTestBase, IClassFixture<WalletFixture>
    {
        ...
        public void ConfirmedTransactionsShouldWipeOutUnconfirmedWithSameInputs()
        {
            ...
            // setup a transaction that will arrive through the mempool.
            ...
            // setup a different transaction spending the same inputs, with a higher fee, that will arrive in a block.
