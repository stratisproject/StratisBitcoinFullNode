...
namespace Stratis.SmartContracts.Networks
{
    ...
    public class SmartContractsPoATest : PoANetwork
    {
        public SmartContractsPoATest()
        {
            ...
            Bitcoin.NBitcoin.Block genesisBlock = CreatePoAGenesisBlock(consensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward);
