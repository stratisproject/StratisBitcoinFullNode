...
namespace Stratis.SmartContracts.Core.Validation
{
    public class ModuleDefValidator
    {
        ...
        {
            foreach (var (validate, result) in this.policy.ModuleDefValidators)
            {
                if (validate(module))
                    results.Add(result(module));
            }
        }
    ...
    public class TypeDefValidator
    {
        ...
        private void ValidateTypeDef(List<ValidationResult> results, TypeDefinition type)
        {
            ...
            foreach (var (nestedPolicy, validate, result) in this.policy.TypeDefValidators)
            {
