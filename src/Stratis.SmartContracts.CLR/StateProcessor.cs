...
namespace Stratis.SmartContracts.CLR
{
    public class StateProcessor : IStateProcessor
    {
            ...
            string type = null)
        {
            ...
            VmExecutionResult result = this.Vm.Create(state.ContractState, smartContractState, state.ExecutionContext, gasMeter, code, parameters, type);
        ...
        private StateTransitionResult ApplyCall(IState state, CallMessage message, byte[] contractCode, RuntimeObserver.IGasMeter gasMeter)
        {
            ...
            VmExecutionResult result = this.Vm.ExecuteMethod(smartContractState, gasMeter, state.ExecutionContext, message.Method, contractCode, type);
