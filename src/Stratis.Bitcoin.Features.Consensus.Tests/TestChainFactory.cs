...
namespace Stratis.Bitcoin.Features.Consensus.Tests
{
    ...
    internal class TestChainFactory
    {
        ...
        public static async Task<TestChainContext> CreateAsync(Network network, string dataDir)
        {
            ...
            ConsensusRules consensusRules = new PowConsensusRules(testChainContext.Network, testChainContext.LoggerFactory, testChainContext.DateTimeProvider, testChainContext.Chain, deployments, consensusSettings, testChainContext.Checkpoints, new InMemoryCoinView(new uint256()), new Mock<ILookaheadBlockPuller>().Object).Register(new FullNodeBuilderConsensusExtension.PowConsensusRulesRegistration(testChainContext.Network, testChainContext.DateTimeProvider));
