...
namespace Stratis.Bitcoin.Features.Consensus.Tests.Rules
{
    public class ConsensusRuleUnitTestBase
    {
        ...
        protected ConsensusChainIndexer ConsensusChainIndexer;
        ...
        protected ConsensusRuleUnitTestBase(Network network)
        {
            ...
            this.nodeDeployments = new NodeDeployments(this.network, this.ConsensusChainIndexer);
        ...
        protected void AddBlocksToChain(ConsensusChainIndexer chainIndexer, int blockAmount)
        {
    ...
    public class PosConsensusRuleUnitTestBase : ConsensusRuleUnitTestBase
    {
        ...
        protected T CreateRule<T>() where T : ConsensusRuleBase, new()
        {
            return new T()
            {
                ...
                Parent = new TestPosConsensusRules(this.network, this.loggerFactory.Object, this.dateTimeProvider.Object, this.ConsensusChainIndexer, this.nodeDeployments,
    ...
    public class ConsensusRuleUnitTestBase<T> where T : ConsensusRuleEngine
    {
        ...
        protected static ConsensusChainIndexer GenerateChainWithHeight(int blockAmount, Network network)
        {
        ...
        protected static ConsensusChainIndexer MineChainWithHeight(int blockAmount, Network network)
        {
            var chain = new ConsensusChainIndexer(network);
            uint256 prevBlockHash = chain.Genesis.HashBlock;
            for (int i = 0; i < blockAmount; i++)
    ...
    public class TestConsensusRulesUnitTestBase : ConsensusRuleUnitTestBase<TestConsensusRules>
    {
        ...
        {
            return new TestConsensusRules(this.network, this.loggerFactory.Object, this.dateTimeProvider.Object, this.ConsensusChainIndexer, this.nodeDeployments,
    ...
    public class TestPosConsensusRulesUnitTestBase : ConsensusRuleUnitTestBase<TestPosConsensusRules>
    {
        ...
        public TestPosConsensusRulesUnitTestBase() : base(KnownNetworks.StratisTest)
        {
            ...
            this.stakeValidator.Setup(s => s.CheckStakeSignature(It.IsAny<BlockSignature>(), It.IsAny<uint256>(), It.IsAny<Transaction>()))
                .Returns((BlockSignature signature, uint256 blockHash, Transaction coinstakeTx) => {
                    var validator = new StakeValidator(this.network, this.stakeChain.Object, this.ConsensusChainIndexer, this.coinView.Object, this.loggerFactory.Object);
        ...
        {
            return new TestPosConsensusRules(this.network, this.loggerFactory.Object, this.dateTimeProvider.Object, this.ConsensusChainIndexer,
