...
namespace Stratis.Bitcoin.Features.Consensus.Tests.Rules.CommonRules
{
    public class BitcoinActivationRuleTest : TestConsensusRulesUnitTestBase
    {
        ...
        public void Run_BadVersionLowerThan2_HeightHigherThanBip34_ThrowsBadVersionConsensusError()
        {
            ...
            header.Version = 1;
            this.ruleContext.ValidationContext.ChainedHeader = new ChainedHeader(header, header.GetHash(), this.consensusRules.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP34]);
        ...
        public void Run_BadVersionLowerThan2_HeightSameAsBip34_ThrowsBadVersionConsensusError()
        {
            ...
            this.ruleContext.ValidationContext.ChainedHeader = new ChainedHeader(header, header.GetHash(), this.consensusRules.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP34] - 1);
        ...
        public void Run_BadVersionLowerThan3_HeightHigherThanBip66_ThrowsBadVersionConsensusError()
        {
            ...
            this.ruleContext.ValidationContext.ChainedHeader = new ChainedHeader(header, header.GetHash(), this.consensusRules.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP66]);
        ...
        public void Run_BadVersionLowerThan3_HeightSameAsBip66_ThrowsBadVersionConsensusError()
        {
            ...
            this.ruleContext.ValidationContext.ChainedHeader = new ChainedHeader(header, header.GetHash(), this.consensusRules.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP66] - 1);
        ...
        public void Run_BadVersionLowerThan4_HeightHigherThanBip65_ThrowsBadVersionConsensusError()
        {
            ...
            this.ruleContext.ValidationContext.ChainedHeader = new ChainedHeader(header, header.GetHash(), this.consensusRules.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP65]);
        ...
        public void Run_BadVersionLowerThan4_HeightSameAsBip65_ThrowsBadVersionConsensusError()
        {
            ...
            this.ruleContext.ValidationContext.ChainedHeader = new ChainedHeader(header, header.GetHash(), this.consensusRules.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP65] - 1);
        ...
        public void Run_GoodVersionHeightBelowBip34_DoesNotThrowException()
        {
            ...
            this.ruleContext.ValidationContext.ChainedHeader = new ChainedHeader(header, header.GetHash(), this.consensusRules.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP34] - 2);
        ...
        public void Run_GoodVersionHeightBelowBip66_DoesNotThrowException()
        {
            ...
            this.ruleContext.ValidationContext.ChainedHeader = new ChainedHeader(header, header.GetHash(), this.consensusRules.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP66] - 2);
        ...
        public void Run_GoodVersionHeightBelowBip65_DoesNotThrowException()
        {
            ...
            this.ruleContext.ValidationContext.ChainedHeader = new ChainedHeader(header, header.GetHash(), this.consensusRules.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP65] - 2);
        ...
        public void Run_GoodVersionAboveBIPS_DoesNotThrowException()
        {
            ...
            this.ruleContext.ValidationContext.ChainedHeader = new ChainedHeader(header, header.GetHash(), this.consensusRules.ConsensusParams.BuriedDeployments[BuriedDeployments.BIP65] + 30);
