...
namespace NBitcoin.Networks
{
    public class BitcoinMain : Network
    {
        public BitcoinMain()
        {
            ...
            this.Genesis = CreateBitcoinGenesisBlock(this, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward);
        ...
        protected static Block CreateBitcoinGenesisBlock(Network network, uint nTime, uint nNonce, uint nBits, int nVersion, Money genesisReward)
        {
