...
namespace Stratis.FederatedPeg.Features.FederationGateway.CounterChain
{
    ...
    public interface ICounterChainSessionManager
    {
       /// <summary>
        ...
        /// <returns></returns>
        Task<uint256> ProcessCounterChainSession(int blockHeight);
        ...
        /// </summary>
        void CreateSessionOnCounterChain(int blockHeight, List<CounterChainTransactionInfoRequest> counterChainTransactionInfos);
