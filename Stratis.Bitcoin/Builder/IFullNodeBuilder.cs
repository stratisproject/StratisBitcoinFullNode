...
namespace Stratis.Bitcoin {
   ...
   public interface IFullNodeBuilder {
      ...
      IFullNodeBuilder UseLoggerFactory(ILoggerFactory loggerFactory);
      ...
      /// <returns>The <see cref="IFullNodeBuilder"/>.</returns>
      IFullNodeBuilder ConfigureLogging(Action<ILoggerFactory> configureLogging);
      ...
      /// <returns>The <see cref="IFullNodeBuilder"/>.</returns>
      IFullNodeBuilder UseSetting(string key, string value);
