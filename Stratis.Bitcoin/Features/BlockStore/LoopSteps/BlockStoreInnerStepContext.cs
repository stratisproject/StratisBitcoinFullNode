...
{
    /// <summary>
    /// Context for the inner steps, BlockStoreInnerStepFindBlocks() and BlockStoreInnerStepDownloadBlocks()
    /// <para>
    ...
    public sealed class BlockStoreInnerStepContext
    {
        ...
        /// the <see cref="InsertBlockSizeThreshold"/> has ben reached
        /// </summary>
        ...
        /// <summary>
        /// Sets the next chained block to process
        /// </summary>
        ...
        /// <summary>
        /// Removes the BlockStoreInnerStepFindBlocks from the routine
        /// <para>
        /// <see cref=">BlockStoreInnerStepFindBlocks.ExecuteAsync"/>
        /// </para>
        /// </summary>
    ...
    /// <summary>
    /// Abstract class that all DownloadBlockSteps implement
    /// <para>
    /// Returns a BlockStoreLoopStepResult 
    /// </para>
    /// </summary>
