...
namespace Stratis.Bitcoin.Features.BlockStore.Tests.LoopTests
{
    ...
    {
        [Fact]
        public async Task BlockStoreInnerStepFindBlocks_WithBlocksFound_AddToDownloadStackAsync()
        {
            ...
            using (var fluent = new FluentBlockStoreLoop())
            {
                ...
                await task.ExecuteAsync(context).ConfigureAwait(false);
        ...
        [Fact]
        public async Task BlockStoreInnerStepFindBlocks_CanRemoveTaskFromRoutine_DownloadStackSizeReachedAsync()
        {
            ...
            using (var fluent = new FluentBlockStoreLoop())
            {
                ...
                await fluent.BlockRepository.PutAsync(blocks.Take(45).Last().GetHash(), blocks.Take(45).ToList()).ConfigureAwait(false);
        ...
        [Fact]
        public async Task BlockStoreInnerStepFindBlocks_CanRemoveTaskFromRoutine_BlockExistsInPendingStorageAsync()
        {
            ...
            using (var fluent = new FluentBlockStoreLoop())
            {
                ...
                await fluent.BlockRepository.PutAsync(blocks.Take(1).Last().GetHash(), blocks.Take(1).ToList()).ConfigureAwait(false);
        ...
        [Fact]
        public async Task BlockStoreInnerStepFindBlocks_CanRemoveTaskFromRoutine_BlockExistsInRepositoryAsync()
        {
            var blocks = CreateBlocks(3);
        ...
        [Fact]
        public async Task BlockStoreInnerStepFindBlocks_CanRemoveTaskFromRoutine_NextChainedBlockIsNullAsync()
        {
            var blocks = CreateBlocks(3);
            ...
            {
                // Push 2 blocks to the repository
                await fluent.BlockRepository.PutAsync(blocks.Take(2).Last().GetHash(), blocks.Take(2).ToList()).ConfigureAwait(false);
