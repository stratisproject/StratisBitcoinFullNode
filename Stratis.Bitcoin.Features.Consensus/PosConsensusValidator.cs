...
namespace Stratis.Bitcoin.Features.Consensus
{
    ...
    public class PosConsensusValidator : PowConsensusValidator
    {
        ...
        public override void ExecuteBlock(ContextInformation context, TaskScheduler taskScheduler)
        {
            ...
            (this.stakeChain as StakeChainStore).Set(context.BlockItem.ChainedBlock, context.Stake.BlockStake);
        ...
        public override void ContextualCheckBlockHeader(ContextInformation context)
        {
            ...
            ChainedBlock chainedBlock = context.BlockItem.ChainedBlock;
            ...
            if (chainedBlock.Header.Time > this.FutureDrift(context.BlockItem.Block.Transactions[0].Time))
            {
            ...
            if (context.Stake.BlockStake.IsProofOfStake()
                && !this.CheckCoinStakeTimestamp(chainedBlock.Height, chainedBlock.Header.Time, context.BlockItem.Block.Transactions[1].Time))
            {
        ...
        public override void CheckBlockHeader(ContextInformation context)
        {
            ...
            context.NextWorkRequired = StakeValidator.GetNextTargetRequired(this.stakeChain, context.BlockItem.ChainedBlock.Previous, context.Consensus,
