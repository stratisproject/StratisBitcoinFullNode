...
namespace Stratis.Bitcoin.Features.Consensus
{
    public class ConsensusStats
    {
        ...
        public void Log()
        {
            ...
            benchLogs.AppendLine("Persistent Tip:".PadRight(LoggingConfiguration.ColumnLength) + this.chain.GetBlock(this.bottom.GetBlockHashAsync().AwaiterResult()).Height);
            if (this.cache != null)
            {
                benchLogs.AppendLine("Cache Tip".PadRight(LoggingConfiguration.ColumnLength) + this.chain.GetBlock(this.cache.GetBlockHashAsync().AwaiterResult()).Height);
