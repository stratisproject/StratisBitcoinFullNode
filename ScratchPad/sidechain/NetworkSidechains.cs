...
namespace NBitcoin
{
	...
	{
		static Network _SidechainMain;
		public static Network SidechainMain {
			get {
				if (_SidechainMain == null)
					_SidechainMain = InitSidechainMain();
				return _SidechainMain;
			}
		}

		static Network _SidechainTest;
		public static Network SidechainTest {
			get {
				if (_SidechainTest == null)
					_SidechainTest = InitSidechainTest();
				return _SidechainTest;
			}
		}

		static Network _SidechainRegTest;
		public static Network SidechainRegTest {
			get {
				if (_SidechainRegTest == null)
					_SidechainRegTest = InitSidechainRegTest();
				return _SidechainRegTest;
			}
		}
		...
		private static Network InitSidechainMain()
		{
			...
			var genesis = CreateSidechainGenesisBlock(1470467000, 1831645, 0x1e0fffff, 1, Money.Zero);
		...
		private static Network InitSidechainTest()
		{
			...
			var genesis = Network.SidechainMain.GetGenesis().Clone();
		...
		private static Network InitSidechainRegTest()
		{
			...
			var consensus = Network.SidechainTest.Consensus.Clone();
		...
		private static Block CreateSidechainGenesisBlock(uint nTime, uint nNonce, uint nBits, int nVersion, Money genesisReward)
		{
